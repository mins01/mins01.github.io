...
- <context-param>, &lt;servlet&gt; (이 두곳에서만 설정된다.)&lt;/servlet&gt;</context-param>
- *로 설정되어있을 수도 있다.
...
- <context docbase="com_test" path="/com_test" reloadable="true" source="org.eclipse.jst.j2ee.server:com_test"></context>  
이런 구문이 추가되어있을 것이다.
...
<component-scan>base-package="egovframework,temp.example"&amp;gt;  &#xD;
        &lt;include-filter expression="org.springframework.stereotype.Controller" type="annotation"&gt;&lt;/include-filter&gt;  &#xD;
        &lt;exclude-filter expression="org.springframework.stereotype.Service" type="annotation"&gt;&lt;/exclude-filter&gt;  &#xD;
        &lt;exclude-filter expression="org.springframework.stereotype.Repository" type="annotation"&gt;&lt;/exclude-filter&gt;  &#xD;
</component-scan>  
  
/src/main/resources/egovframework/spring/context-common.xml  
<component-scan>base-package="egovframework,temp.example"&amp;gt;  &#xD;
       &lt;exclude-filter expression="org.springframework.stereotype.Controller" type="annotation"&gt;&lt;/exclude-filter&gt;  &#xD;
</component-scan>  
...
- SQL-Map 설정
- <property name="dataSource" ref="egov.dataSource"></property>로 DB소스 설정함.(context-datasource.xml 파일 참고)
...
모든 Connector  에 대해서 적어줘야할 듯</connector>
...
- 
- #패키기 기준으로 설정.  
<logger additivity="false" name="temp.example">  &#xD;
&lt;span class="Apple-tab-span" style="white-space: pre;"&gt;&lt;/span&gt;&lt;level value="DEBUG"&gt;&lt;/level&gt;  &#xD;
&lt;span class="Apple-tab-span" style="white-space: pre;"&gt;&lt;/span&gt;&lt;appender-ref ref="console"&gt;&lt;/appender-ref&gt;  &#xD;
</logger>
- 
- #기본 로그 설정  
<root>  &#xD;
&lt;span class="Apple-tab-span" style="white-space: pre;"&gt;&lt;/span&gt;&lt;level value="OFF"&gt;&lt;/level&gt;  &#xD;
&lt;span class="Apple-tab-span" style="white-space: pre;"&gt;&lt;/span&gt;&lt;appender-ref ref="console"&gt;&lt;/appender-ref&gt;  &#xD;
</root>
...
- <set value="${requestScope['javax.servlet.error.exception']}" var="exception"></set>
- ${exception}
...
- - - - - -&amp;#xD;
&amp;#xD;
&lt;/div&gt;&lt;div&gt;# 전자전부 표준 프레임 워크&lt;/div&gt;게시판 부분 분석EgovBBSManagerController.java----=------@Autowired(required=false) &lt;div&gt;    private EgovBBSCommentService bbsCommentService; //bbsCommentService라는 객체는 EgovBBSManagerController에서 객체 만들 때 소스상에 new 부분이 없어도 만들어진다. (커플링(연결도)을 줄이위 위한거라네... 요즘 추세라네)&lt;/div&gt;----=------&lt;div&gt; @RequestMapping("/cop/bbs/selectBoardList.do") &amp;lt;div&amp;gt;    public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {}&amp;lt;/div&amp;gt;&lt;/div&gt;&lt;div&gt;  &amp;#xD;
&lt;/div&gt;&lt;div&gt;아규먼트로 넘어오는 BoardVO boardVO 나 ModelMap model 는 selectBoardArticles 메소드를 호출할 때 자동으로 생성되어 호출된다. (아마 스프링쪽에서 해주는 것 같음(상세 조사 필요)&lt;/div&gt;&lt;div&gt;  &amp;#xD;
&lt;/div&gt;
